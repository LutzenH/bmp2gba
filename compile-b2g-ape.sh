...
gcc -g -Ofast -static -nostdlib -nostdinc -fno-pie -no-pie -mno-red-zone \
  ...
  -DB2G_APE -o bmp2gba.com.dbg src/b2g_main.c src/b2g_types.h src/b2g_builder.c src/b2g_builder.h src/b2g_version.h src/b2g_platform.c src/b2g_platform.h -fuse-ld=bfd -Wl,-T,ape.lds -Wl,--gc-sections \
